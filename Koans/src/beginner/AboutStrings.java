...
public class AboutStrings {
    ...
    public void implicitStrings() {
        Object obj = new String("any string");
        assertEquals("just a plain ole string".getClass(), obj.getClass());
        // both returns java.lang.String class (class of object)
    }
    ...
    public void newStringIsRedundant() {
        ...
        // .equals() checks if 2 pointers have same state or value.
    }
    ...
    public void newStringIsNotIdentical() {
        ...
        // == checks if 2 pointers pointing to same memory location
    }
    ...
    public void stringIsEmpty() {
        ...
        // if string length is 0, then its empty.
    }
